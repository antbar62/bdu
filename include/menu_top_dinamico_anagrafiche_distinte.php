           ...
           <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
	                    ...
	                    <ul class="dropdown-menu">
							...
							<li class="dropdown-submenu">
			                     ...
			                     <ul class="dropdown-menu">
					                ...
					                if ($_SESSION['tipologiaprestatore'] == 4){
									?>
			                     	<li>
					                ...
					                <li >
					                     <a href="/backoffice/iscrizioni/professionisti_equitalia/compilazione_fattura.php?tipo_richiesta=3">Professionista ad Equitalia</a>
					                </li>
					                <?php 	
									}
									?>
                    ...
                    <li class="dropdown">
						...
						else  if ($_SESSION['tipologiaprestatore'] == 1){
						?>
                    	...
                    	else  if ($_SESSION['tipologiaprestatore'] == 2){
						?>
